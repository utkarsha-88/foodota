...
@Component({
  selector: 'app-briyaniitems',
  templateUrl: './briyaniitems.component.html',
  styleUrls: ['./briyaniitems.component.css']
})
export class BriyaniitemsComponent implements OnInit {
